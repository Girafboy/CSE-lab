...
clean_files=rpc/rpctest rpc/*.o rpc/*.d *.o *.d yfs_client extent_server lock_server lock_tester lock_demo rpctest test-lab-3-b test-lab-3-c rsm_tester part1_tester
.PHONY: clean handin
clean: 
	rm $(clean_files) -rf 
...
handin: 
	...
	@echo Please modify lab1.tgz to lab1_[your student id].tgz and upload it to ftp://LuXuKun:public@public.sjtu.edu.cn/upload/cse/lab1
	@echo Thanks!
